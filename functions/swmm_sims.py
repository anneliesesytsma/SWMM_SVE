...
def paths(P,current_dir,folder):
    ...
    input: 
    1. 'P' precip scenario
    2. 'current dir' current directory
    ...
    write_path = '\\'.join([current_dir, 'inp_files\\'+str(folder)+'\\'+str(write)])
    read_path = '\\'.join([current_dir, 'inp_files\\'+str(folder)+'\\'+str(read)])
